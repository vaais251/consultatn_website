...
export const metadata: Metadata = {
    title: "Log In / Register — GB Guide",
    description: "Sign in to your GB Guide account or create a new one to start booking consultations.",
};
            ...
            <div className="w-full max-w-md">
                ...
                <div className="glass rounded-2xl p-8">
                    ...
                    <p className="text-slate-500 text-sm text-center mt-6">
                        ...
                        <span className="text-accent-400 cursor-pointer hover:underline">Register</span>
                    </p>
                </div>

                <p className="text-slate-600 text-xs text-center mt-4">
                    🚧 Auth with NextAuth (email + Google OAuth) coming soon
                </p>
            </div>
        </section>
    );
